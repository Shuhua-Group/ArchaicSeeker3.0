#!/bin/bash
#SBATCH --job-name=2src_tgt10
#SBATCH --output=2src_tgt10_%j.out
#SBATCH --error=2src_tgt10_%j.err
#SBATCH --array=0-799
#SBATCH --mem=1G
...
for i in {0..1}; do
  ...
  if [[ -f "$chunk_file" ]]; then
    ...
    if [[ -n "$line" ]]; then
      ...
      python /home/linhuanyu/83_AS3_SSTAR/sstar-analysis/workflows/new/src2_tgt10_sim.py $line
    else
