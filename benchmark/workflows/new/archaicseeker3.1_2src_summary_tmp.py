...
summary_out = os.path.join(output_dir, "inference/ArchaicSeeker3.1/AS3_Mamba_Smoother_4096_2048_0_2src_accuracy.txt")
            ...
            for ntgt in ntgt_list:
                for seed in seed_list:
                    ...
                    try:
                        ...
                        bed_out_1 = os.path.join(prefix, f"AS3_Mamba_Smoother_4096_2048_0.out.cutoff.{cutoff}.src1.bed")
                        bed_out_2 = os.path.join(prefix, f"AS3_Mamba_Smoother_4096_2048_0.out.cutoff.{cutoff}.src2.bed")
                        bed_out = os.path.join(prefix, f"AS3_Mamba_Smoother_4096_2048_0.out.cutoff.{cutoff}.bed")
                        acc_out = os.path.join(prefix, f"AS3_Mamba_Smoother_4096_2048_0.out.cutoff.{cutoff}.accuracy")
