...
summary_out = os.path.join(output_dir, "inference/ArchaicSeeker3.1/AS3_Mamba_NSmoother_4096_2048_M5216_1src_accuracy.txt")
                ...
                for seed in seed_list:
                    for cutoff in cutoff_list:
                        try:
                            ...
                            seg_file = os.path.join(prefix, "AS3_Mamba_NSmoother_4096_2048_M5216.bed")
                            true_file = os.path.join(output_dir, f"simulated_data/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/sim1src.introgressed.tracts.bed")
                            bed_out = os.path.join(prefix, f"AS3_Mamba_NSmoother_4096_2048_M5216.out.cutoff.{cutoff}.bed")
                            acc_out = os.path.join(prefix, f"AS3_Mamba_NSmoother_4096_2048_M5216.out.cutoff.{cutoff}.accuracy")
