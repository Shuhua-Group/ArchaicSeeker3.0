...
# 定义输出文件路径
true_merged_file = os.path.join(output_dir, f"simulated_data/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}", f"merged_true_tracts_{demog}_nref{nref}_ntgt{ntgt}_seed{seed}.bed")
inferred_merged_file = os.path.join(output_dir, f"simulated_data/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}", f"merged_inferred_tracts_{demog}_nref{nref}_ntgt{ntgt}_seed{seed}.bed")
