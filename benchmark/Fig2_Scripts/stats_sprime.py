...
def main():
    ...
    out_accuracy = out_dir / f"AS2_1210.sample.accuracy"
    ...
    # else:
    pre_seg_all, pre_seg_1, pre_seg_2, pre_seg_3, recall_seg_all,recall_seg_1,recall_seg_2,acc, DM, NM, DN, ND ,dis_end_mean,dis_start_mean,dis_abs_mean,dis_abs_std,dis_rel_mean,dis_rel_std= analyze_infer_sim_13(best_matches_infersim, best_matches_siminfer, min_overlap_sim_ratio=0)

    with open(out_accuracy, "w") as f:
        f.write(
            f"1210\t{demo}\t{nref}\t{ntgt}\t{seed}\t"
