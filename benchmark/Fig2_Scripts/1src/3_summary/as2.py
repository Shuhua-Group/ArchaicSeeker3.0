...
acc_out = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker2.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_1src.accuracy"

# # 先写表头（若不需要可去掉）
# with open(acc_out, "w") as f:
#     f.write("demog\tnref\tntgt\tseed\tcutoff\tlevel\tprecision\trecall\tf1\n")

infered_bed = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker2.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_1src.bed"
