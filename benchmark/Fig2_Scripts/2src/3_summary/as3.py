import sys, os
ACC_DIR = "/home/linhuanyu/share1/20_AS3/0_Scripts/2src/3_summary/acc.py"
...
acc_out = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker3.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_2src.accuracy"
...
infered_src_bed = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker3.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_2src_src.bed"
infered_src1_bed = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker3.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_2src_src1.bed"
infered_src2_bed = f"/home/linhuanyu/share1/20_AS3/results/inference/ArchaicSeeker3.0/{demog}/nref_{nref}/ntgt_{ntgt}/{seed}/Infered_2src_src2.bed"
...
src12_hap_prec, src12_hap_rec, src12_hap_f1       = cal_accuracy_hap(sim_src1_bed, infered_src2_bed)              # 如需传 sample_col，请加参数\\
src12_sample_prec, src12_sample_rec, src12_sample_f1= cal_accuracy_sample(sim_src1_bed, infered_src2_bed)
src12_region_prec, src12_region_rec, src12_region_f1 = cal_accuracy_region(sim_src1_bed, infered_src2_bed)

src21_hap_prec, src21_hap_rec, src21_hap_f1       = cal_accuracy_hap(sim_src2_bed, infered_src1_bed)              # 如需传 sample_col，请加参数\\
src21_sample_prec, src21_sample_rec, src21_sample_f1= cal_accuracy_sample(sim_src2_bed, infered_src1_bed)
src21_region_prec, src21_region_rec, src21_region_f1 = cal_accuracy_region(sim_src2_bed, infered_src1_bed)
...
with open(acc_out, "a") as acc_f:  # 追加
    ...
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc12\thap\t{src12_hap_prec}\t{src12_hap_rec}\t{src12_hap_f1}\n")
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc12\tsample\t{src12_sample_prec}\t{src12_sample_rec}\t{src12_sample_f1}\n")
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc12\tregion\t{src12_region_prec}\t{src12_region_rec}\t{src12_region_f1}\n")
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc21\thap\t{src21_hap_prec}\t{src21_hap_rec}\t{src21_hap_f1}\n")
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc21\tsample\t{src21_sample_prec}\t{src21_sample_rec}\t{src21_sample_f1}\n")
    acc_f.write(f"{demog}\t{nref}\t{ntgt}\t{seed}\tsrc21\tregion\t{src21_region_prec}\t{src21_region_rec}\t{src21_region_f1}\n")
