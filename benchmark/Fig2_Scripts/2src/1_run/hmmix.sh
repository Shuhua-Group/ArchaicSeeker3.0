#!/bin/bash
#SBATCH --job-name=hmmix_2src_chunk1
#SBATCH --output=%x_%a.out
#SBATCH --error=%x_%a.err
#SBATCH --mem=5G
#SBATCH --cpus-per-task=1
#SBATCH --array=0-799  # 替换XXX为任务数量减1，比如有20组任务就是0-19
...
# 准备参数列表
TASK_LIST="/home/linhuanyu/share1/20_AS3/results/inference/0_Scripts/2src/0_batch/2src_chunk1.txt"  # ✨ 你需要提前准备好，每行一个参数组合
