...
def main():
    ...
    as3dir = Path("/home/linhuanyu/share1/20_AS3/results/inference/DAIseg/simulated_result")
    ...
    if demo in ["AS2_HumanNeanderthalDenisovan", "ChimpBonoboGhost","HumanArchaic","HumanNeanderthalDenisovan"]:
        ...
        src_AS2_bed = out_dir / f"Infered_2src.bed"
        src1_AS2_bed = out_dir / f"Infered_2src.bed"
        src2_AS2_bed = out_dir / f"Infered_2src.bed"
        ...
        src_AS2_bed = out_dir / f"Infered_1src.bed"
        src1_AS2_bed = out_dir / f"Infered_1src.bed"
        src2_AS2_bed = out_dir / f"Infered_1src.bed"
        # process_Archaic_bed(src1_sim_bed, src2_sim_bed, src_sim_bed, src_sim_info_bed)

    out_accuracy = out_dir / f"AS2_1211.sample.accuracy"

    Archaic_prec, Archaic_rec, Archaic_f1, Archaic_ratio = cal_accuracy_sample(src_sim_bed, src_AS2_bed)
    ...
    # else:
    Den_prec, Den_rec, Den_f1, Den_ratio                 = cal_accuracy_sample(src1_sim_bed, src1_AS2_bed)
    Nean_prec, Nean_rec, Nean_f1, Nean_ratio             = cal_accuracy_sample(src2_sim_bed, src2_AS2_bed)
