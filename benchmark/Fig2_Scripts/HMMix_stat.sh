...
# seed=956714
cd /home/linhuanyu/share1/20_AS3/results/inference/HMMix
...
for demo in AncientEurasia AS2_HumanNeanderthalDenisovan BonoboGhost ChimpBonoboGhost HumanArchaic HumanNeanderthal HumanNeanderthalDenisovan OOANeanderthal Skov_HumanDenisovan; do
    for nref in 10 50; do
        for ntgt in 1 10; do
            cd "/home/linhuanyu/share1/20_AS3/results/inference/HMMix/${demo}/nref_${nref}/ntgt_${ntgt}/${seed}"
            python /home/linhuanyu/share1/20_AS3/0_Scripts/stats_HMMix.py \
                --demo ${demo} \
                --nref ${nref} \
                --ntgt ${ntgt} \
                --seed ${seed}
