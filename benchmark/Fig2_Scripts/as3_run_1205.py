...
def run_one(args):
    ...
    output_bed = out_path / "introgression_prediction.raw.bed"
    ...
    with gpu_locks[gpu_id]:
        ...
        cd {out_path}
        /usr/bin/time -v /home/linhuanyu/02_Software/ArchaicSeeker3_memFast_TwoStage/ArchaicSeeker3.1-mamba -t {tgt_vcf} -r {ref_vcf} -m {map_file} -o {out_path} --merge 0
        """
