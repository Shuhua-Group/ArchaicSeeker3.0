...
def run_one(args):
    ...
    output_dir = Path(
        "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/10_ArchaicNum/"
    )
    ...
    ref_vcf = out_path / f"ref_{prefix}.vcf.gz"
    tgt_vcf = out_path / "target.vcf.gz"
    map_file = f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/10_ArchaicNum/ref_{prefix}.map"
    merge_distance = 0
