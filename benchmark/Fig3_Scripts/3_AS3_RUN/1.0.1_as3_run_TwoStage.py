...
def run_one(args):
    ...
    merge_distance = 5000
    prefix = "AS3_Merge_TwoStage_5000"
    ...
    with gpu_locks[gpu_id]:
        ...
        cd {out_path}
        /usr/bin/time -v /share/home/linhuanyu/02_Software/ArchaicSeeker3_memFast_GeneticMap_Integrated_TwoStage/ArchaicSeeker3.1-mamba -t {tgt_vcf} -r {ref_vcf} -m {map_file} -o {out_path} --merge {merge_distance}
