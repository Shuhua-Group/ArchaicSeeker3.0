...
def run_one(args):
    ...
    output_dir = Path(
        "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/3_LongSeg/"
    )
    out_path = output_dir / str(seed)

    out_path.mkdir(parents=True, exist_ok=True)

    ref_vcf = out_path / "ref.Max100Mb.vcf.gz"
    tgt_vcf = out_path / "target.Max100Mb.vcf.gz"
    map_file = out_path / "ref.map"
    merge_distance = 0
    prefix = "AS3_Merge_0_100Mb"
