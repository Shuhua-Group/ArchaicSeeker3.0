...
def run_one(args):
    ...
    output_dir = Path(
        "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/9_TgtNum/"
    )
    out_path = output_dir / str(seed)
    out_path.mkdir(parents=True, exist_ok=True)

    prefix = "250"
    out_bed_path = out_path / prefix
    out_bed_path.mkdir(parents=True, exist_ok=True)

    ref_vcf = out_path / "ref.vcf.gz"
    tgt_vcf = out_path / f"target{prefix}.vcf.gz"
    map_file = "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/9_TgtNum/ref.map"
    merge_distance = 0
    ...
    with gpu_locks[gpu_id]:
        ...
        cd {out_path}
        /usr/bin/time -v /home/linhuanyu/02_Software/ArchaicSeeker3_memFast_TwoStage/ArchaicSeeker3.1-mamba -t {tgt_vcf} -r {ref_vcf} -m {map_file} -o {out_bed_path} --merge {merge_distance}
        # /share/home/linhuanyu/02_Software/ArchaicSeeker3_memFast_GeneticMap_Integrated_TwoStage/merge_bed_segments.py -i {out_path}/introgression_prediction.raw.bed -o {out_path}/exact_merged.bed -d {merge_distance}
        """
        success = False
    ...
    # intro_raw = out_path / "exact_merged.bed"
...
# ===========================
seed_file = Path(
    "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/0_Config/seeds_small.txt"
)
