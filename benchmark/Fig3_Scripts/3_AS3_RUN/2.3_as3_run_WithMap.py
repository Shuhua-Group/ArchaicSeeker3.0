...
def run_one(args):
    ...
    output_dir = Path(
        "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/2_WithMap/"
    )
    ...
    merge_distance = 0
    prefix = "AS3_Merge_0_MAP_withMAP"
    ...
    with gpu_locks[gpu_id]:
        ...
        cd {out_path}
        /usr/bin/time -v /home/linhuanyu/02_Software/ArchaicSeeker3_memFast_GeneticMap_Integrated/ArchaicSeeker3.1-Mamba-Integrated/ArchaicSeeker3.1-mamba \\
            -g /home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/0_Config/chr19.b38.map.as3.txt -t {tgt_vcf} -r {ref_vcf} -m {map_file} -o {out_path} --merge {merge_distance}
        """
