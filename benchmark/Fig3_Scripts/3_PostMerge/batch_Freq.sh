#!/bin/bash
#SBATCH --job-name=RefFreq_FilterMerge
...
for prefix in ACgt0 ACgt1 ACgt2 ACgt10 ACgt20 
do
    cd "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/5_RefFreq/${seed}/${prefix}"
    cp introgression_prediction.raw.bed introgression_prediction.raw.bk.bed
    cp introgression_prediction.raw.snps.gz introgression_prediction.raw.bk.snps.gz
    cp introgression_prob_matrix.txt introgression_prob_matrix.bk.txt

    python /home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/3_PostMerge/FilterMerge_RefFreq.py \
        --seed "$seed" \
        --prefix "$prefix"
done
