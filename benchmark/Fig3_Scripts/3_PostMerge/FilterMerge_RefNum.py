...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ref_num", type=int, required=True, help="ref_num")
...
def main():
    ...
    basedir = Path("/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/8_RefNum/")
    out_dir = basedir / str(seed) 
    res_dir = basedir / str(seed) / str(ref_num)
    prefix = f"{ref_num}"
