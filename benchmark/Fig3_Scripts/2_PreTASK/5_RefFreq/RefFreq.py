...
def main():
    ...
    # 输出文件夹
    outdir = Path(f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/5_RefFreq/{seed}")
    ...
    Ref_map = "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/5_RefFreq/ref.map"
    tgt_list = "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/5_RefFreq/tgt.list"
    ...
    subprocess.run(f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/5_RefFreq/make_ref_by_AC.sh {Ref_vcf} {outdir}", shell=True)
