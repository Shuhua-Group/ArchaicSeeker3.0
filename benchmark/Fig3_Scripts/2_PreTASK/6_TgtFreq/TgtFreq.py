...
def main():
    ...
    # 输出文件夹
    outdir = Path(f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/6_TgtFreq/{seed}")
    ...
    Ref_map = "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/6_TgtFreq/ref.map"
    ref_list = "/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/6_TgtFreq/ref.list"
    ...
    subprocess.run(f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/6_TgtFreq/make_Target_by_AF.sh {Target_vcf} {outdir}", shell=True)
