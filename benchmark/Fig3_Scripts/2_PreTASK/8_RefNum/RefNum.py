...
def main():
    ...
    # 输出文件夹
    outdir = Path(f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/2_Data/8_RefNum/{seed}")
    ...
    for ref_num in [5, 10, 25, 50, 100]:
        ref_list = f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/8_RefNum/ref{ref_num}.list"
        ref_map = f"/home/linhuanyu/share1/25_AS_Real/ArchaicSeeker3/500.Simulation_10J19/1_Scripts/2_PreTASK/8_RefNum/ref{ref_num}.map"
        Ref_vcf_path = outdir / f"ref{ref_num}.vcf.gz"
        Ref_map_path = outdir / f"ref{ref_num}.map"
